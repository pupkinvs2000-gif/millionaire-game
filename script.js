...
const questions = [
    ...
    },
    {
        ...
        answers: ["A: Здорова заебал", "B: Приветики пистолетики", "C:  Здравствуйте", "D: Мииииууу"],
        correct: 3,
        level: 1
    },
    {
        question: "Кто покупает таблетки для потенции?",
        answers: ["A: Чалов", "B: Бердников", "C: Вова Глазков", "D: Плетнев"],
        correct: 0,
        level: 1
    },
    {
    ...
    {
        question: "В каком году основан 'Востокмелаллургмонтаж'?",
        answers: ["A: 1934", "B: 1984", "C: 2004", "D: на следующий день после сотворения мира"],
        correct: 0,
        level: 2
    },
    {
        question: "В каком соотношении смешивается цемент с песком в класическом рецепте?",
        answers: ["A: 1/2", "B: на глаз", "C: 1/1", "D: 1/3"],
        correct: 3,
        level: 2
    },
    {
        question: "В какой стране ВММ строило Великаю Китайскаю стену?",
        answers: ["A: У собственника на даче", "B: Китай", "C: Индия", "D: Монголия"],
        correct: 1,
        level: 2
    },
    // Вопросы 11-15 (сложные)
    {
        question: "За чей счет проводятся медицинские осмотры работников, работающих во вредных и опасных условиях труда?",
        answers: ["A: За счет работников", "B: За счет Фонда социального страхования", "C: За счет средств работодателя", "D: За счет Фонда медицинского страхования"],
        correct: 2,
        level: 3
    },
    {
        question: "Какое время работы относится к ночной смене?",
        answers: ["A: С 24 часов до 7 часов", "B: С 1 часа ночи до 7 часов", "C: С 23 часов до 6 часов", "D: С 22 часов до 6 часов"],
        correct: 3,
        level: 3
    },
    {
        question: "Профессиональные заболевания классифицируются:",
        answers: ["A: Тяжелые, легкие", "B: Острые, хронические", "C: Кратковременные, длительные", "D: Приобретенные, врожденные"],
        correct: 1,
        level: 3
    },
    {
    ...
    {
        question: "В какой срок расследуется несчастный случай?",
        answers: ["A: 3 суток и сутки на составление акта формы Н1", "B: 15 суток", "C: 10 суток", "D: Решает комиссия по расследованию несчастного случая"],
        correct: 0,
        level: 3
    }
];
    ...
    setTimeout(() => {
        ...
        if (selectedIndex !== question.correct) {
            ...
            if (gameState.currentQuestion === 15) {
                // Выиграл миллион!
                console.log('🎉 ПОБЕДА! Все 15 вопросов пройдены!');
                setTimeout(() => {
                    endGame(true);
                }, 2000);
            } else {
...
function useFiftyFifty() {
    ...
    showHint('50/50', 'Два неправильных ответа были скрыты, Хз какие, наугад выбрал!');
}
...
function usePhone() {
    ...
    if (confidence > 0.7) {
        ...
        message = `Виталька говорит: "Честно говоря я у Машки, она мне гуся душет прямо сейчас и тяжело думать, но пусть будет ${randomLabel}. Вероятность около 40%."`;
    }
...
function endGame(won, customMessage = null) {
    ...
    if (won) {
        ...
        if (gameState.currentQuestion === 15) {
            ...
            if (elements.qrText) {
                elements.qrText.textContent = 'за неадекватное поведение ИЗВОЗЧИКА фирма ответственности не несет, если будет стрелять мелочь на еду, не обращайте внимания, мы ее кормим раз в сутки, пусть не жалуется!';
            }
...
Вы успешно ответили на все 15 вопросов с помощью высших сил 💀, гугла 👩‍💻, гаданий 🔮, и сбору сплтен на работе 🗣️!
