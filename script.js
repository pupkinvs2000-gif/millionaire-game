...
function endGame(won, customMessage = null) {
    ...
    if (won) {
        ...
        if (gameState.currentQuestion === 15) {
            ...
            if (elements.qrText) {
                elements.qrText.textContent = 'за неодекватное повидение ИЗВОЗЧИКА фирма ответственности не несет, если будет стрелять мелочь на еду, не обращайте внимания, мы ее кормим раз в сутки, пусть не жалуется!';
            }
